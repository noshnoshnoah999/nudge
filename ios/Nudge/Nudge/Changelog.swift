...
enum Changelog {
    static let entries: [ChangelogEntry] = [
        ChangelogEntry(
            ...
            added: [],
            changed: [
                "Fixed a bug where double-tapping a word to select it didn't work when editing an existing reminder's title or notes on iPhone (worked fine for new reminders and on Mac)"
            ]),
        ChangelogEntry(
